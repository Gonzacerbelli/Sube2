    ...
    <main role="main">
      ...
      <hr class="featurette-divider">
        ...
        <div class="row" style="text-align:center;">
          <div class="col-lg-4">
            <img class="rounded-circle" src="images/tarifa_social.png" alt="Generic placeholder image" width="140" height="140">
            <h2>Tarifa Social</h2>
          ...
          <div class="col-lg-4">
            <img class="rounded-circle" src="images/conseguila.png" alt="Generic placeholder image" width="140" height="140">
            <h2>Conseguila</h2>
