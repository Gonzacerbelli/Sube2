...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-07-2018 a las 03:44:36
...
(1, '2018-07-03 00:59:00', 10, 1, 1, 4, NULL, 1, 5),
(2, '2018-07-03 01:40:00', 7.5, 2, 2, 2, 52, 7, NULL),
(3, '2018-07-06 00:59:00', 10, 3, 1, 4, NULL, 1, 5);
...
INSERT INTO `movimiento` (`idMovimiento`, `tipo`, `detalle`, `fechaHora`, `valor`, `idTarjeta`, `medio`) VALUES
(1, 'Uso Transporte', '', '2018-07-03 00:00:00', 10, 16, ''),
(2, 'Uso Transporte', '', '2018-07-03 00:00:00', 7.5, 16, 'Plaza de Mayo'),
(3, 'Uso Transporte', '', '2018-07-06 00:00:00', 10, 16, '');
...
(2, 'Stefano', 'Dalessandro', 41196319, '12345678', 'stefano1dalessandro@gmail.com'),
(3, 'Pablo', 'Cabrera', 40100100, '12345678', 'pablocabrera@gmail.com');
...
(1, 1, 6, '2018-06-10', '2018-06-05', b'1');
...
INSERT INTO `usuario_tiene_rol` (`idUsuarioRol`, `idUsuario`, `idRol`) VALUES
(1, 1, 1),
(2, 2, 2),
(5, 3, 3);
...
(1, '2018-07-03 00:59:00', 16, 1),
(2, '2018-07-03 01:40:00', 16, 1),
(3, '2018-07-06 00:59:00', 16, 1);
...
ALTER TABLE `usuario_tiene_rol`
  ...
  ADD KEY `fk_ur_usuario_idx` (`idUsuario`),
  ADD KEY `fk_ur_rol_idx` (`idRol`);
...
--
ALTER TABLE `beneficio`
  MODIFY `idbeneficio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `red_sube`
  MODIFY `idRedSube` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tarjeta`
  MODIFY `idTarjeta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `usuario_tiene_rol`
  ADD CONSTRAINT `fk_ur_rol` FOREIGN KEY (`idRol`) REFERENCES `rol` (`idRol`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ur_usuario` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
